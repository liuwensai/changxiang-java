...
function getTrackList(orderType){
	...
	var url ="/user/user-jc-track!getOtherUserTrackDg.action";
	var postData={};
		...
		try {
			...
			if (json && json.flag == 1) {
				for(var i=0;i<json.msg.length;i++){
					...
					html=html+ "<li onclick=\"window.location='jcz_track_otherUserTrackDg.html?tmId="+tm.tmId+"&userId="+tm.userId+"'\"><div class=\"d-box\">" +
