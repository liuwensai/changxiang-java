...
function createTrack(){
	...
	para.gg_type = $("#gg_type option:selected").val();//追号类型
...
function init_page(){
	...
	if(type && type==2){
		...
		if(para){
			...
			//第二场
			$("#spTwo_min").val(para.spTwoMin==0?1.5:para.spTwoMin);
			$("#spTwo_max").val(para.spTwoMax==0?1.6:para.spTwoMax);
			//第三场
			$("#spThree_min").val(para.spThreeMin==0?1.5:para.spThreeMin);
			$("#spThree_max").val(para.spThreeMax==0?1.6:para.spThreeMax);
			//第四场
			$("#spFoue_min").val(para.spFoueMin==0?1.5:para.spFoueMin);
			$("#spFoue_max").val(para.spFoueMax==0?1.6:para.spFoueMax);
			if(para.gg_type==0){
				...
				$('#sp_3').hide();
				$('#sp_4').hide();
				var html= "<option value='0' selected='selected'>单关配</option>" +
						"<option value='2'>2串1</option>" +
						"<option value='3'>3串1</option>" +
						"<option value='4'>4串1</option>";
                $("#gg_type").html(html);
			}else if(para.gg_type==2){
				$("#sp_2").show();
				
				$('#sp_0').hide();
				$('#sp_3').hide();
				$('#sp_4').hide();
				var html= "<option value='0'>单关配</option>" +
				"<option value='2' selected='selected'>2串1</option>" +
				"<option value='3'>3串1</option>" +
				"<option value='4'>4串1</option>";
				$("#gg_type").html(html);
			}else if(para.gg_type==3){
				...
				var html= "<option value='0'>单关配</option>" +
				"<option value='2'>2串1</option>" +
				"<option value='3' selected='selected'>3串1</option>" +
				"<option value='4'>4串1</option>";
				$("#gg_type").html(html);
			}else if(para.gg_type==4){
				$("#sp_0").hide();
				...
				"<option value='2'>2串1</option>" +
				"<option value='3'>3串1</option>" +
				"<option value='4' selected='selected'>4串1</option>";
				$("#gg_type").html(html);
			}
