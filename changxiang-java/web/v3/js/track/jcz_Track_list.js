...
function getTrackList(para){
	...
	*/
	var url ="/user/user-jc-track!toMain.action";
	var postData={};
		...
		try {
			...
			if (json && json.flag == 1) {
				...
				for(var i =0;i<obj.length;i++){
					...
					html=html+"<li class=\"d-box\" onclick=\"window.location='/v3shtml/trade/jczq/track/jcz_track_detail.html?tm_id="+obj[i].tmId+"'\">"
