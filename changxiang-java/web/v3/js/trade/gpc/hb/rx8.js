...
$(document).ready(function(){
	...
	//判断是否是登陆后返回
	if(temp_login_exist("hbrx8lotCode")){
		var numberContent = read_temp_login("hbrx8numberContent") ;
		var pls_bs = read_temp_login("hbrx8_bs") ;
		var pls_qs = read_temp_login("hbrx8_qs") ;
...
//	}
	...
	if(!checkLoginByAjax()){		
		...
		write_temp_login("hbrx8lotCode" , "20" , 1) ;
		write_temp_login("hbrx8numberContent" , numberContent , 1) ;
		write_temp_login("hbrx8_play" , gpc.playId , 1) ;
		write_temp_login("hbrx8_bs" , multiple , 1) ;
		write_temp_login("hbrx8_qs" , trackCount , 1) ;
		//登录
		var bakUrl = "/v3shtml/trade/gpc/hb/rx8.shtml" ;
		to_login(bakUrl);
		return ;
	}
