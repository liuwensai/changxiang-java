...
$(document).ready(function(){
	...
	//判断是否是登陆后返回
	if(temp_login_exist("hbrx2lotCode")){
		var numberContent = read_temp_login("hbrx2numberContent") ;
		var pls_bs = read_temp_login("hbrx2_bs") ;
		var pls_qs = read_temp_login("hbrx2_qs") ;
...
//	}
	...
	if(!checkLoginByAjax()){		
		...
		write_temp_login("hbrx2lotCode" , "1" , 1) ;
		write_temp_login("hbrx2numberContent" , numberContent , 1) ;
		write_temp_login("hbrx2_play" , gpc.playId , 1) ;
		write_temp_login("hbrx2_bs" , multiple , 1) ;
		write_temp_login("hbrx2_qs" , trackCount , 1) ;
		//登录
		var bakUrl = "/v3shtml/trade/gpc/hb/rx2.shtml" ;
		to_login(bakUrl);
		return ;
	}
