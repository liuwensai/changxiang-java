...
$(document).ready(function(){
	...
	//判断是否是登陆后返回
	if(temp_login_exist("hbq3zhxlotCode")){
		var numberContent = read_temp_login("hbq3zhxnumberContent") ;
		var pls_bs = read_temp_login("hbq3zhx_bs") ;
		var pls_qs = read_temp_login("hbq3zhx_qs") ;
...
//	}
	...
	if(!checkLoginByAjax()){		
		...
		write_temp_login("hbq3zhxlotCode" , "1" , 1) ;
		write_temp_login("hbq3zhxnumberContent" , numberContent , 1) ;
		write_temp_login("hbq3zhx_play" , gpc.playId , 1) ;
		write_temp_login("hbq3zhx_bs" , multiple , 1) ;
		write_temp_login("hbq3zhx_qs" , trackCount , 1) ;
		//登录
		var bakUrl = "/v3shtml/trade/gpc/hb/q3zhx.shtml" ;
		to_login(bakUrl);
		return ;
	}
