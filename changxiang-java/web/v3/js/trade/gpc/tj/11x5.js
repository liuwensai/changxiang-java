...
gpc.issueid = "";
gpc.lotid = 21;     // 河北11选5
gpc.playId = 21007;  // 全局 默认任五玩法
gpc.listCode = new Array();     // 保存所有的选号数据 // [21007_04#09,08,01,02,10]
gpc.ht_play_id = 21030; // 混投
gpc.qr_play_id = 21015; // 前二直选
gpc.qs_play_id = 21018; // 前三直选
...
//通过玩法获取玩法名
var playStrDic={21001:'任选二',21002:'任2胆拖',21003:'任三',21004:'任3胆拖',21005:'任四',21006:'任四胆拖',21007:'任五',21008:'任五胆拖',21009:'任六',21010:'任六胆拖',21011:'任七',21012:'任七胆拖',21013:'任八',21014:'前一',21015:'前二直选',21016:'前二组选',21017:'前二组选胆拖',21018:'前三直选',21019:'前三组选',21020:'前三组选胆拖',21021:'任八胆拖',21030:'混合投注'};
function getplayData(playId){
	return playStrDic[playId];
}
//通过玩法获取奖金
var playSingeMoneyStrDic={21001:6,21003:19,21005:78,21007:540,21009:90,21011:26,21013:9,21014:13,21015:130,21016:65,21018:1170,21019:195};
function getSingeMoney(playId){
	return playSingeMoneyStrDic[playId];
}

// 机选个数  ( 直选比较特殊 )
var pldIdToPlayId={21001:2,21003:3,21005:4,21007:5,21009:6,21011:7,21013:8,21014:1,21015:2,21016:2,21018:3,21019:3};
	...
	$("#play_ul_id li").click(function() {
		...
		$("#play_ul_id li").each(function(index, el) {
			...
			if(switchPlayId == pid){
				...
				}else if(gpc.playId <= 21005 || gpc.playId == 21016 || gpc.playId == 21019){ // 任二、任三、任四、前二组选、前三组选
...
//	}
	...
	if(!checkLoginByAjax()){		
		...
		//登录
		var bakUrl = "/v3shtml/trade/gpc/tj/11x5.shtml" ;
		to_login(bakUrl);
		return ;
	}
