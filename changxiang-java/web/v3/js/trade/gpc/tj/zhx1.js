...
$(document).ready(function(){
	...
	//判断是否是登陆后返回
	if(temp_login_exist("tjq1zhxlotCode")){
		var numberContent = read_temp_login("tjq1zhxnumberContent") ;
		var pls_bs = read_temp_login("tjq1zhx_bs") ;
		var pls_qs = read_temp_login("tjq1zhx_qs") ;
...
//	}
	...
	if(!checkLoginByAjax()){		
		...
		write_temp_login("tjq1zhxlotCode" , "1" , 1) ;
		write_temp_login("tjq1zhxnumberContent" , numberContent , 1) ;
		write_temp_login("tjq1zhx_play" , gpc.playId , 1) ;
		write_temp_login("tjq1zhx_bs" , multiple , 1) ;
		write_temp_login("tjq1zhx_qs" , trackCount , 1) ;
		//登录
		var bakUrl = "/v3shtml/trade/gpc/tj/zhx1.shtml" ;
		to_login(bakUrl);
		return ;
	}
