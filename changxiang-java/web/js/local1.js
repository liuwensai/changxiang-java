...
local={
	...
	NavInit:function(u,m){
		...
		if(u.length>0){
			...
			location.href='/login.html';
			h+='欢迎来到乐娱彩票！<a onclick="local.login()" href="javascript:void(0);">请登录</a> <a target="_blank" href="/R.html">免费注册</a></div>';
		}
		$('#topNavLeft').html(h);
	},
	ScrollImg:function(){//图片轮询
		...
		$('#cpIndexAdBox div.ctrol a').mouseover(function(){
			...
			$('#cpIndexAdBox .adList').animate({left:'-'+CurrentIndex*1670+'px'},200);
		});
		var p=function(){
