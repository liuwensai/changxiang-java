...
<%
	...
	String keyValue	= formatString("33B4DB3244BB5C2875D98CB1B79B68DA");	// 商家密钥
	String nodeAuthorizationURL = formatString("http://www.mgpay.cn/GateWay/Bank.aspx");// 交易请求地址
	// 商家设置用户购买商品的支付信息
	String p0_Cmd = formatString("Buy");// 在线支付请求，固定值 ”Buy”
	String p1_MerId = formatString("10000");// 商户编号
	...
	String p8_Url = formatString("http://210.209.117.249:8089/pay/alipay/callback.jsp");// 商户接收支付成功数据的地址
