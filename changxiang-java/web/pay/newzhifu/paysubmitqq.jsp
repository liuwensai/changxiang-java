...
<div class="g-head f-shadow">
    <div class="g-hd-c f-hc">
        <span class="m-logo"></span><span class="m-title">qq收银台</span>
...
<%
	...
	String AdviceURL ="http://520babe.com/pay/newzhifu/notifyqq.jsp";   //[必填]异步通知地址
	...
	if (money>=50&&null!=pa_MP){
	    ...
	    if (null!=find){
	     int uid = find.getUser_id();
			...
			String payMode =  "00024";//支付方式， 00024-qq扫码(固定值)（M）
...
<div class="m-pay-way" id="otherPayTypeDiv">
    ...
    <div class="m-pay-t wechatpay">
        ...
        <span class="m-pay-name">qq扫码支付</span>
    ...
    <div class="m-pay-mn" style="display: block;">
        ...
        <div class="m-box" id="wechatPayWrap">
            ...
            <div class="m-bl">
                ...
                <p class="u-wechat-p" id="wechatBtn">qq扫码支付</p>
